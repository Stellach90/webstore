...
document.getElementById('products').innerHTML += getProductAsHtmlString(products[4])
document.getElementById('products').innerHTML += getProductAsHtmlString(products[5])
...
document.getElementById('products').innerHTML += getProductAsHtmlString(product[1])

/*const arrOfHtmlProducts = product.map(getProductAsHtmlString);
