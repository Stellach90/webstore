  ...
  if (product.qty < 100) {
    ...
    <form class="disappear">
      ...
      <footer>
        ...
        <button type="button" onclick = "addOneToCart()" id="addOne"><span class="material-icons">add_shopping_cart</span></button>
        <button type="button" onclick = "addOneToList()" id="addList"><span class="material-icons">favorite</span></button>
      </footer>
    </form>
  </article>`;
  }
